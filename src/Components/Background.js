...
const Background = () => {    
    return(
        <Element name="background">
            <h3 className="text-center mb-4 text-uppercase">My Background</h3>
            <ul className="nav nav-tabs mb-5 d-flex justify-content-center" id="background" role="tablist">
                ...
                <li className="nav-item" role="presentation">
                <button className="nav-link" id="experience-tab" data-bs-toggle="tab" data-bs-target="#experience" type="button" role="tab" aria-controls="experience" aria-selected="false">Work Experience</button>
                </li>
                <li className="nav-item" role="presentation">
                <button className="nav-link" id="organization-tab" data-bs-toggle="tab" data-bs-target="#organizations" type="button" role="tab" aria-controls="organizations" aria-selected="false">Organizations</button>
                </li>
                <li className="nav-item" role="presentation">
                    <button className="nav-link" id="achievements-tab" data-bs-toggle="tab" data-bs-target="#achievements" type="button" role="tab" aria-controls="achievements" aria-selected="false">Achievements</button>
                </li>
                <li className="nav-item" role="presentation">
            ...
            <div className="tab-pane fade show active" id="education" role="tabpanel" aria-labelledby="education-tab">
                ...
                <p>2019 - 2023</p>
                <p>Grade: Second className Honors (Upper Division)</p>
            ...
            <div className="tab-pane fade" id="experience" role="tabpanel" aria-labelledby="experience-tab">
                ...
                <h6><span className="text-uppercase">Period:</span> 27/9/2023 - Present</h6>
                <p>Tasks</p>
                <ul>
                ...
                <p><span className="text-uppercase">Address:</span> Hass Plaza, Lower Hill Road, Nairobi</p>
                <h6><span className="text-uppercase">Period:</span> 28/12/2021 - 25/03/2022</h6>
                <p>Tasks</p>
                <ul>
            ...
            <div className="tab-pane fade" id="organizations" role="tabpanel" aria-labelledby="organization-tab">
