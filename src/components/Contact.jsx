      ...
      <Element name="contact">
        ...
        <div className="p-4 rounded-lg alternate-background">
          <form className="w-full mx-auto" onSubmit={handleSubmit}>
              ...
              <button type="submit" className="text-white bg-gradient-to-r from-blue-500 to-blue-700 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-lg text-sm px-4 py-2.5 text-center me-2 mb-2">Submit</button>
            </form>
        </div>
